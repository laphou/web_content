...
<script src="<?php get_theme_url(); ?>/assets/js/sidr.js"></script> <script src="<?php get_theme_url(); ?>/assets/js/waypoints.js"></script> <script src="<?php get_theme_url(); ?>/assets/js/waypoints-sticky.js"></script> 
